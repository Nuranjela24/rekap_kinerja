...
<body>
    ...
    ?>
    <center>
        <h2 style="margin-bottom: 1px;">RS BORNEO CITRA MEDIKA</h2>
    </center>
    <center>
        <p style="margin-top: 1px;font-size: 12px;">Jalan A. Yani RT 7B RW. 03 Pelaihari 70814 Telepon (0512) 2021002</p>
    </center>
    <hr style="border: 1px solid #000; margin: 20px 0;">
    <center>
        <h4 style="margin-bottom: 1px;">REKAP NILAI KINERJA <?php echo $cek == 'Semua' ? '' : strtoupper($bdg['nama_bidang']) ?></h4>
    </center>
    <center>
        <h4 style="margin-top: 1px; margin-bottom: 0;">RUMAH SAKIT BORNEO CITRA MEDIKA</h4>
    </center>
    <!-- </div> -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <b>
                            <p style="margin-top: 0;margin-bottom: 0;">Bulan : <?= bulanindo(date('m')) ?> <?= date('Y') ?></p>
                        </b>
